...
<!-- -------------------------------------------------------------------------------- -->
    ...
    <div data-js="search-event-index-wrapper" class="index-wrapper">
        ...
        <div id="{{'index-'.$listing->id}}" data-intersection-observer="index-card">
            <a href="#{{$listing->id}}" class="text-decoration-none text-reset">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="d-flex p-1">
                                    <img src="{{$listing->image->first()->path}}" alt="" class="event-index-image">
                                    <div class="d-flex flex-column align-items-start ml-2">
                                        <h6 class="m-0">{{$listing->title}}</h6>
                                    </div>
                                </div>
