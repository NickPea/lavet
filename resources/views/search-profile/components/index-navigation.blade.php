...
<div data-js="search-profile-index-wrapper" class="index-wrapper">
    ...
    <div id="{{'index-'.$profile->id}}" data-intersection-observer="index-card">
        <a href="#{{$profile->id}}" class="text-decoration-none text-reset">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="d-flex p-1">
                                <img src="{{$profile->image->first()->path}}" alt="" class="profile-index-image">
                                <div class="d-flex flex-column align-items-start ml-2">
                                    <h6 class="m-0">{{$profile->user->name}}</h6>
                                </div>
                            </div>
...
<script>
    function SideNavigation() {
        ...
        let indexWrapper = document.querySelector('[data-js="search-profile-index-wrapper"]')
