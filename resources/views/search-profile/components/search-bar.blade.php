    ...
    <div class="container my-5">
        ...
        <div class="row">
            <div class="col-10 offset-1">
                ...
                <h5 class="py-2 font-weight-bold ">Search veterinary people</h5>

                


                        <div class="d-flex">
                            <a href="{{url('search/event')}}" class="search-bar-button">
                                <h5 class="m-0 p-0">Events</h5>
                            </a>
                            <a href="{{url('search/listing')}}" class="search-bar-button">
                                <h5 class="m-0 p-0">Jobs</h5>
                            </a>
                            <a href="{{url('search/profile')}}" class="search-bar-button search-bar-button-active">
